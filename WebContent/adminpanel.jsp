...
<script src="js/adminoption.js"></script>
</head>
	...
	<nav class="w3-sidebar w3-collapse w3-white w3-animate-left"
		...
		<div class="w3-bar-block">
			<a onclick="getusers()"
				...
				class="fa fa fa-user-circle fa-fw w3-margin-right"></i>USERS</a> <a
				onclick="getcandidate()"
				class="w3-bar-item w3-button w3-padding w3-text-teal"><i
				class="fa fa-users fa-fw w3-margin-right"></i>CANDIDATES</a> <a
				onclick="election()"
				class="w3-bar-item w3-button w3-padding w3-text-teal"><i
				class="fa fa-handshake-o fa-fw w3-margin-right"></i>ELECTIONS</a> <a
				onclick="result()"
				class="w3-bar-item w3-button w3-padding w3-text-teal"><i
